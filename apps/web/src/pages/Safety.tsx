    ...
    <div className="container-narrow" style={{ margin: '0 auto' }}>
      <article className="card">
        <div className="card-body legal-doc">
          <h1>Trust &amp; safety</h1>
          <p>
            SkillSplore provides organised profiles, request moderation, reporting tools and clear
            community rules. Learners and providers remain responsible for deciding whether an
            arrangement is suitable.
          </p>
          <h2>What we provide</h2>
          <ul>
            <li>Profiles and requests can be reported at any time.</li>
          ...
          <p>
            Use the report option on any profile, request, message or review. Our moderation team
            reviews reports and can hide content or suspend accounts that break the rules.
          </p>
        </div>
      </article>
    </div>
